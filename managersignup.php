<html>
  ...
  <head>
    <title> Registrar Admi | Le Cafe' </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hola Admi, <br> Bienvenido a <span class="edit"> Le Cafe' </span></h1>
     <br>
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="manager_registered_success.php" method="POST">
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="fullname" type="text" name="fullname" placeholder="Nombre Completo" required="" autofocus="">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="contact" type="text" name="contact" placeholder="Ingresa algun numero de telefono de celular" required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="password"><span class="text-danger" style="margin-right: 5px;">*</span> Contraseñ: </label>
            <div class="input-group">
