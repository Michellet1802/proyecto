...
<html>
  ...
  <head>
    <title> Explorar | Food Le Cafe' </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"> Zona de Comida</a></li>
            <li><a href="cart.php">Carrito  (<?php
...
<ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Registrarse <span class="caret"></span> </a>
              ...
              <li> <a href="#"> Registrarse Admi</a></li>
            </ul>
            </li>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>¡Uy! No hay comida disponible.</h1> </label>
        <p>Mantente hambriento ...! : P</p>
      </center>
