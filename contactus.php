      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="contactus.php">Contacto </a></li>
          </ul>
...
?>
    ...
    <div class="heading">
     <strong>Quiere contactar <span class="edit"> Le Cafe' </span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Contacto Formulario</h3>
          ...
          <div class="form-group">
           ...
           <span class="help-block"><p id="characterLeft" class="help-block">Max Caracteres : 140 </p></span>
          </div> 
...
if (!$success){
  die("No se pudieron ingresar datos ".$conn->error);
}
