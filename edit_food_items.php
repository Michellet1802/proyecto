...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="edit_food_items.php" class="list-group-item active">Editar Comida</a>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDITA TU COMIDA AQUI </h3>

          <div class="form-group">
            <input class='input' type='hidden' name="dfid"<?php echo $row1['F_ID'];  ?> >
          </div>

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Platillo: </label>
            <input type="text" class="form-control" id="dname" name="dname"<?php echo $row1['name'];  ?> placeholder="Tu Platillo" required="">
          </div>     

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Precio: </label>
            <input type="text" class="form-control" id="dprice" name="dprice" <?php echo $row1['price'];  ?> placeholder="Precio de la Comida" required="">
          </div>

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span>Descripcion: </label>
            <input type="text" class="form-control" id="ddescription" name="ddescription" <?php echo $row1['description'];  ?> placeholder="Descripcion" required="">
          </div>
